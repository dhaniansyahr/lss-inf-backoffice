...
export default function DialogAdd(props: IDialogAddProps) {
    ...
    const form = useForm<TMahasiswaRequest>({
        defaultValues: mahasiswaToValues(null),
        resolver: zodResolver(schema),
    });

    const createFn = useMutation(service.mahasiswa.create(params));
    ...
    return (
        <Modal ref={props.dialogRef} title="Tambah Data Mahasiswa Baru">
            <Form {...form}>
